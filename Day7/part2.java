...
public class part2 {
    ...
    public static int classify(String card) {
        ...
        } else if (mostMatch + J == 4) {
            return 2; //four of a kind
        } else if (mostMatch + J == 3 && mostMatch2 >= 2 || mostMatch2 + J == 3 && mostMatch >= 2) {
            return 3; //full house
        } else if (mostMatch + J == 3) {
            return 4; //three of a kind
        } else if (mostMatch == 2 && mostMatch2 + J == 2) {
            return 5; //two pair
        } else if (mostMatch + J == 2) {
            return 6; //one pair
        }
        return 7; //high card
    }
